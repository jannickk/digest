...
This folder defines all source code for the 'proteomics-pipeline' pipeline:
...
* Take a look at the sample under "sample_users_proteomics_pipeline.py" to get familiar with the syntax.
